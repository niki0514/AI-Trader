...
def enrich_security_info(raw: dict[str, Any], config: dict[str, Any]) -> dict[str, Any]:
    ...
    turnover_rate_proxy = to_float(raw.get("turnover_rate_proxy"))
    turnover_rate = to_float(raw.get("turnover_rate"), turnover_rate_proxy)
    ...
    return {
        ...
        "relative_amount": to_float(raw.get("relative_amount")),
        "volume": to_float(raw.get("volume")),
        "daily_pct_change": to_float(raw.get("daily_pct_change"), to_float(raw.get("pct_change"))),
        "available_quantity": available_quantity,
        "northbound_net_flow": to_float(raw.get("northbound_net_flow")),
        "market_data_source": str(raw.get("market_data_source") or raw.get("data_source") or "snapshot"),
        "technical_flags": str(raw.get("technical_flags") or ""),
        "technical_summary": str(raw.get("technical_summary") or ""),
        "ma20": to_float(raw.get("ma20")),
        "ma60": to_float(raw.get("ma60")),
        "price_vs_ma20": to_float(raw.get("price_vs_ma20")),
        "price_vs_20d_high": to_float(raw.get("price_vs_20d_high")),
        "return_5d": to_float(raw.get("return_5d")),
        "return_20d": to_float(raw.get("return_20d")),
        "volatility_20d": to_float(raw.get("volatility_20d")),
    }
